...
# Query Selector
my_list = ['aestheic','travel','greener-cities','people','computers','ai','power','grey','real','wallpapers','arts-culture','beautiful','spirituality','abstract','wallart','painting','poetry','3d-renders','street-photography','textures-patterns','textures-patterns','fashion-beauty','qoutes','experimental','art','photography','gore','sweet','architecture-interior','lines','bad','good','tumblr','random','pakistan']
